package com.qkartbismuth.ktc.ui.widgets
...
import com.qkartbismuth.ktc.college.teacher.TeacherDay
import com.qkartbismuth.ktc.college.teacher.TeacherTimetable
import com.qkartbismuth.ktc.ui.activities.MainActivity
        ...
        CollegeApi.fetchTeacherTimetable(branchId, teacherId, object : CollegeCallback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                for (l in day.lessons) {
                    // cancelled lessons are not shown
                    if (l.group == "" || l.status == 1) continue
                    lesson = RemoteViews(context.packageName, R.layout.widget_tlesson)
                    with (lesson) {
                        setTextViewText(R.id.widget_tlesson_title, l.title)
                        setTextViewText(R.id.widget_tlesson_classroom, l.actual_classroom ?: l.classroom)
